...
const calendar = new FullCalendar.Calendar(calendar_node, {
    ...
    dateClick: function(info) {
        ...
        let date_selected = info.date.toLocaleString("en-IN", {
            "dateStyle": "long"
        });
...
discount_percent_field.addEventListener("focusout", ()=>{
    ...
    negotiated_price.textContent = `(-)${new Intl.NumberFormat("en-IN", {
        style: "currency",
        currency: "INR"
    }).format(negotiated_price_value)}`;
    discount_price.textContent = new Intl.NumberFormat("en-IN", {
        style: "currency",
        currency: "INR"
...
cash_redeem_field.addEventListener("focusout", ()=>{
    ...
    final_price.textContent = new Intl.NumberFormat("en-IN", {
        style: "currency",
        currency: "INR"
